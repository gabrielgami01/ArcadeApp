...
extension Font {
    ...
    static let customFootnote = Font.custom("VT323", size: 15, relativeTo: .footnote)
    static let customCaption = Font.custom("VT323", size: 14, relativeTo: .caption)
    static let customCaption2 = Font.custom("VT323", size: 13, relativeTo: .caption2)
}
